        ...
        <View style={styles.MainView}>
            ...
            >
                ...
                <View style={styles.MidHeading}>
                    <Text style={styles.MidHeadingTxt}>
                        {'Realizar pago.'}
                    </Text>
                </View>
                ...
                <View style={styles.PaymentMethodView}>
                    <Image
                        source={mastercard}
                        style={styles.mastercardStyling}
                    />

                    <Image
                        source={visa}
                        style={styles.VisaStyling}
                    />
                </View>
...
const styles = StyleSheet.create({
    MainView: { flex: 1 },
    MainTxtView: { alignItems: 'center', backgroundColor: '#98809C', padding: 10, flexDirection: 'row', justifyContent: 'center' },
    ...
    SubHeadingTxtView: { backgroundColor: '#967F9A', paddingHorizontal: 15, paddingVertical: 5 },
    ...
    TextInput1: { marginHorizontal: 20, backgroundColor: 'white', opacity: 0.4, marginTop: 20 },
    PlaceholderStyle: { paddingVertical: 3, fontWeight: 'bold' },
    TextInput2: { marginHorizontal: 20, backgroundColor: 'white', opacity: 0.4, marginTop: 5 },
    PlaceholderStyle2: { paddingVertical: 3, fontWeight: 'bold' },
    MergeViews: { flexDirection: 'row' },
    TextInput3: { marginLeft: 20, backgroundColor: 'white', opacity: 0.4, marginTop: 5, flexGrow: 1 },
    PlaceholderStyle3: { paddingVertical: 3, fontWeight: 'bold' },
    TextInput4: { marginRight: 20, marginLeft: 5, alignItems: 'center', paddingVertical: 0, backgroundColor: 'white', opacity: 0.4, marginTop: 5, flexGrow: 1 },
    ...
    ButtonView: { marginTop: 30, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginHorizontal: 120, backgroundColor: '#98809C' },
