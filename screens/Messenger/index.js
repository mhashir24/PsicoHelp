        ...
        <View style={styles.MainView}>
            ...
            >
                ...
                <View style={styles.ChatView1}>
                    ...
                    <Text style={styles.ChatTxtTime1}>
                        {'2:20'}
                    </Text>
                </View>
                ...
                <View style={styles.ChatView2}>
                    ...
                    <Text style={styles.ChatTxtTime2}>
                        {'2:22'}
                    </Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    OnlineStatus: { width: 10, height: 10, borderRadius: 50, zIndex: 1, position: 'absolute', left: 65, top: 48, backgroundColor: '#95F139' },
    TxtStyleView: { justifyContent: 'center', alignItems: 'center', flexGrow: 1, paddingRight: 10 },
    TxtStyle:{ fontSize: 18, color: 'white', fontWeight: 'bold' },
    ImageBackground: {zIndex: 1, opacity: 10, width: '100%', height: '100%'},
    ChatView1: {
        width: '90%', borderWidth: 1, paddingVertical: 10, paddingHorizontal: 5,
        marginLeft: 10, marginTop: 20, borderRadius: 10, backgroundColor: '#E6E0E6', borderColor: '#98819C'
    },
    ChatTxt1:{ color: '#98889A' },
    ChatTxtTime1: { paddingLeft: 280, color: '#98889A', marginTop: 5 },
    ChatView2: {
        width: '90%', paddingVertical: 15, paddingHorizontal: 20,
        marginLeft: 30, marginTop: 20, borderRadius: 10,
        backgroundColor: 'white'
    },
    ChatTxt2: { color: '#907592' },
    ChatTxtTime2: { paddingLeft: 250, color: '#98889A', marginTop: 5 },
    ChatView3: {
        width: '90%', height: 60, borderWidth: 1, paddingVertical: 10, paddingHorizontal: 5,
        marginLeft: 10, marginTop: 20, borderRadius: 10, backgroundColor: '#E6E0E6', borderColor: '#98819C'
    },

    TextBox: { backgroundColor: 'white', marginHorizontal: 10, height: 100, marginTop: 100 }
